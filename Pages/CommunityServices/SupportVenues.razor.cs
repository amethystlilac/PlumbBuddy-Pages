...
partial class SupportVenues
{
    const string markdown =
        """
        When a player gets an error, or when they need help with a mod, or when they need help with anything game related, there’s a convenient button in PlumbBuddy that they can click and be guided through finding that help. If you want to offer help with your own mods or help in general, here’s how you can do that.
    ...
    [
        ...
        new("Support Venues", "/community-services/support-venues", icon: MaterialDesignIcons.Normal.FaceAgent)
    ];
}
