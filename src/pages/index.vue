...
<script setup>
  ...
  const carouselItems = [
    {
      background: '/src/assets/boseong.jpg',
      color: 'success',
    ...
    {
      background: '/src/assets/mod_health_scans.jpg',
      color: 'primary',
      title: 'Mod Health',
    ...
    {
      background: '/src/assets/arcane_vault.jpg',
      color: 'secondary',
      title: 'Archivist',
    ...
    {
      background: '/src/assets/santorini.jpg',
      color: 'secondary',
      title: 'Parlay',
    ...
    {
      background: '/src/assets/construction_workers.jpg',
      color: 'tertiary',
