...
It also comes with some useful tools for modding.

For players, it's a place where they can have the website scan their Mods folder (or their mc_lastexception, BE-ExceptionReport.html, or Lumpinou File Log File) for various things, like outdated or broken mods.
...
If you'd like to list your mods on Mod Hound, instructions are available [here](https://app.ts4modhound.com/index#modder_instructions). Note that Mod Hound is meant for mods only, and not custom content. 
